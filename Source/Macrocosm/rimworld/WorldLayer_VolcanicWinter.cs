...
{
    class WorldLayer_VolcanicWinter : WorldLayer, ICloudLayer
    {
        ...
        private static WorldLayer_VolcanicWinter instance;
        public static WorldLayer_VolcanicWinter Instance
        {
            get { return instance; }
        }
        
        public WorldLayer_VolcanicWinter()
        {
            instance = this;
        }
        ...
        public override IEnumerable Regenerate()
        {
            ...
            if (Macrocosm.saveData != null && Macrocosm.saveData.RunningEventManager != null && Macrocosm.saveData.RunningEventManager != null)
            {
                ...
                {
                    if (runningEvent is RunningEvent_VolcanicWinter)
                    {
                        tiles.AddRange((runningEvent as RunningEvent_VolcanicWinter).TileIDs);
                    }
                }
            }           
            ...
            foreach (int tile_ID in tiles)
            {
                ...
                Material mat = WorldMaterials_Macrocosm.Mat_VolcanicWinter;
